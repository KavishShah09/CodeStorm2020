...
function About() {
  return (
    <div className="about">
          ...
          <Col>
            <Card border="success" bg="dark" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  We try to educate consumers about repairing and recycling
                  their clothes and operate repairing services. We also use old
          ...
          <Col>
            <Card border="success" bg="dark" style={{ width: "18rem" }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  Beyond the materials stage, We reduce energy use in our
                  warehouses, stores and offices. Small improvements like
      ...
      <br />
      <div className="container-fluid  rating-system d-flex justify-content-center ">
        <Card
        ...
        >
          <Card.Body>
            ...
            <Card.Text>
              Despite this being our lowest rating, with our re-use and recycle
              methods, manufacture of these goods causes 20% less emissions than
        ...
        <Card border="dark" bg="warning" style={{ width: "50rem" }}>
          <Card.Body>
            ...
            <Card.Text>
              We use recyclable eco-friendly material in the manufacture of
              these goods, causing 40% less emissions than regular pieces of
              clothing.
            </Card.Text>
          </Card.Body>
        </Card>
        ...
        >
          <Card.Body>
            ...
            <Card.Text>
              We use 100% recycled material + Reused material in the manufacture
              of these goods, Reducing the emissions caused by a whopping 60%!
            </Card.Text>
          </Card.Body>
        </Card>
      </div>
